...
export default function MajorRecommendationsPage({ onScholarshipClick, onBack }: MajorRecommendationsPageProps) {
  ...
  const filteredScholarships = majorScholarships.filter((item) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl font-black text-gray-900">전공 맞춤 추천</h1>
        </div>
              ...
              {filteredScholarships.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 text-left">
                    ...
                    {item.conditions.major && (
                      <div className="mt-1 flex flex-wrap gap-1">
                        {item.conditions.major.map((major, idx) => (
        ...
        {filteredScholarships.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-lg">전공 맞춤 장학금이 없습니다</p>
          </div>
        )}
      </div>
    </div>
